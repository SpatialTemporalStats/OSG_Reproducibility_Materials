################################################################################################
# This file includes Monte Carlo assessment of FSG emulation variability                       #
################################################################################################
...
set.seed(9)                                       # seed=1, 2, ..., 10, we would not use a loop here to generate 10*10 emulations because of the computation limitation
...
write.csv(Iuq.u.full,here("Case_Studies/MC","Iuq_u_full_9.csv"))
...
write.csv(Ibc.full,here("Case_Studies/MC","Ibc_full_9.csv"))

# Itc1.u for temporal correlations at lag=1
Itc1.u.full=get.ITC1(Genu.rsd,Windu.rsd)
write.csv(Itc1.u.full,here("Case_Studies/MC","Itc1_u_full_9.csv"))

# Iwdt.u for marginal distribution
Iwdt.u.full=get.IWDT(Gen.Dat.U.full,Windu.ARP)
write.csv(Iwdt.u.full,here("Case_Studies/MC","Iwdt_u_full_9.csv"))
# t2=proc.time()[[3]]
# t2-t1
