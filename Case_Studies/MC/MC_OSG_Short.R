################################################################################################
# This file includes Monte Carlo assessment of OSG-Short emulation variability                 #
################################################################################################
...
### OSG-Short evaluation
# Iuq.u for Uncertainty 
Iuq.u.online=get.IUQ(Gen.Dat.U.online,Windu.ARP)
write.csv(Iuq.u.online,here("Case_Studies/MC","Iuq_u_short_9.csv"))

# Ibc for bivariate correlations
...
write.csv(Ibc.online,here("Case_Studies/MC","Ibc_short_9.csv"))

# Itc1.u for temporal correlations at lag=1
Itc1.u.online=get.ITC1(Genu.rsd,Windu.rsd)
write.csv(Itc1.u.online,here("Case_Studies/MC","Itc1_u_short_9.csv"))

# Iwdt.u for marginal distribution
Iwdt.u.online=get.IWDT(Gen.Dat.U.online,Windu.ARP)
write.csv(Iwdt.u.online,here("Case_Studies/MC","Iwdt_u_short_9.csv"))
